              ...
              <tbody>
                ...
                <?php foreach ($purchases as $purchase): ?>
                  <tr>
                    ...
                    <td class="sum2"><?= $purchase->total ?></td>
                    <td><?= h($purchase->date) ?></td>
                    <td class="actions text-right">
                        <?= $this->Html->link(__('View'), ['controller'=> 'Purchases', 'action' => 'view', $purchase->id], ['class'=>'btn btn-info btn-xs']) ?>
                        <?= $this->Html->link(__('Edit'), ['controller'=> 'Purchases', 'action' => 'edit', $purchase->id], ['class'=>'btn btn-warning btn-xs']) ?>
                        <?= $this->Form->postLink(__('Delete'), ['controller'=> 'Purchases', 'action' => 'delete', $purchase->id], ['confirm' => __('Are you sure you want to delete # {0}?', $purchase->id), 'class'=>'btn btn-danger btn-xs']) ?>
                    </td>
                  </tr>
                <?php endforeach; ?>
              </tbody>
