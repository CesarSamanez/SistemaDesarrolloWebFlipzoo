      ...
      <div class="box box-solid">
        ...
        <div class="box-body">
          <dl class="dl-horizontal">
            ...
            <!--<dd><?= $purchase->has('user') ? $this->Html->link($purchase->user->name, ['controller' => 'Users', 'action' => 'view', $purchase->user->id]) : '' ?></dd> -->
      ...
      <div class="box box-solid">
        ...
        <div class="box-body">
          ...
          <table class="table table-hover">
              ...
              <?php endforeach; ?>
              <tr>
              <?php $subtotal=($purchase->total)*100/118; ?>
              <td></td> <td>SUB-TOTAL</td> <td></td> <td> <?php echo $subtotal; ?></td>
              </tr>
              <tr>
              <td></td> <td>IGV</td> <td></td> <td> <?php echo ($purchase->total)-$subtotal; ?></td>
              </tr>
              <tr>
              <td></td> <td>TOTAL</td> <td></td> <td> <?php echo $purchase->total; ?></td>
              </tr>
          </table>
          <?php endif; ?>
        </div>
