...
class TableUsesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'initial_date' => ['type' => 'datetime', 'length' => null, 'null' => false, 'default' => 'current_timestamp()', 'comment' => '', 'precision' => null],
        'final_date' => ['type' => 'datetime', 'length' => null, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null],
        '_indexes' => [
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'time' => '20:44:04',
                'total' => 1.5,
                'initial_date' => '2019-07-25 20:44:04',
                'final_date' => '2019-07-25 20:44:04'
            ],
        ];
        parent::init();
    }
